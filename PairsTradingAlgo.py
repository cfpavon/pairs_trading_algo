...
if __name__ == "__main__":
    ...
    crude_trade0=PairsTrader(pair="crude_oil",igconnector=igconnector,days="0,1,2,3,4",hours="*/4",minutes="3",monitor_min="0-59/5",monitoring=True,sec_offset=10)
    ...
    spdow_arbitrage=PairsTraderIDX(pair="spdow",igconnector=igconnector,days="0,1,2,3,4",hours="*/4",minutes="13",monitor_min="2-59/5",monitoring=True,sec_offset=10)
